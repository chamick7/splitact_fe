...
import { faSignInAlt, faPowerOff,faAddressCard,faUsers,faExclamationCircle,faInfoCircle,faPager } from "@fortawesome/free-solid-svg-icons";
import { faComments,faEdit,faQuestionCircle,faAddressBook  } from "@fortawesome/free-regular-svg-icons";
      ...
      <div className={styles.dropdown}>
        <ul className={styles.dropmenu}>
...

          {
            ...
            <>
            <hr className={styles.hr} />
            <DropItem icon={faPowerOff} word="Sign out" type="logout" to="/"/>
            </>:<></>
          }
